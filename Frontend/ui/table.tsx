...
>(({ className = "", ...props }, ref) => (
  <tfoot
    ref={ref}
    className={`border-t bg-neutral-100/50 font-medium [&>tr]:last:border-b-0 dark:bg-neutral-800/50 ${className}`}
    {...props}
  />
))
...
>(({ className = "", ...props }, ref) => (
  <caption
    ref={ref}
    className={`mt-4 text-sm text-neutral-500 dark:text-neutral-400 ${className}`}
    {...props}
  />
))
